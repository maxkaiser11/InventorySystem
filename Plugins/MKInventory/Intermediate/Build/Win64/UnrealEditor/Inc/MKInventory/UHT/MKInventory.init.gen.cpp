...
void EmptyLinkFunctionForGeneratedCodeMKInventory_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MKInventory()
	{
		if (!Z_Registration_Info_UPackage__Script_MKInventory.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_MKInventory_NoRoomInInventory__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MKInventory(Z_Construct_UPackage__Script_MKInventory, TEXT("/Script/MKInventory"), Z_Registration_Info_UPackage__Script_MKInventory, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x7D3AE1BF, 0x29D1FEE5));
